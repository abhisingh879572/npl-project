          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            {skillsData.map((skill) => (
              <div
                ...
                className="p-4 space-y-3 text-center text-white duration-300 rounded-lg card group sm:space-y-6 sm:py-16 bg-dark hover:bg-cyan-950 hover:text-white"
              >
                ...
                <a
                  href={skill.link}
                  className="inline-block py-3 text-lg font-semibold duration-300 text-primary group-hover:text-white"
                >
                  Learn more
                </a>
              </div>
